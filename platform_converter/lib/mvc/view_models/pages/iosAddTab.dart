...
import '../../controller/sharepefrence.dart';
...
class _IosAddTabState extends State<IosAddTab> {
  ...
  Widget build(BuildContext context) {
    ...
    String defaultTime=DateFormat('dd/mm/yy').format(DateTime.now());
     String dates=date.toString()=="null"?defaultTime:"${date!.day}/${date!.month}/${date!.year}" ;
                  ...
                  CupertinoButton(
                    ...
                    if(_formKey.currentState!.validate())
                    {
                      setState(() {
                        ...
                        chatmodel.add(ChatModel(id:uuid.v1() , image: imageFile?.path??'', name: name.text, phone: phone.text, msg: chat.text, date:dates  , time: datetime.toString()));
                        name.clear();
                        phone.clear();
                        chat.clear();
                        date=null;
